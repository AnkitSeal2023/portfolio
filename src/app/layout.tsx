...
export const metadata: Metadata = {
	...
	description:
		"Portfolio of Ankit Seal, a full-stack developer specializing in React, Next.js, TypeScript, Node.js, and DevOps. Explore innovative projects, technical expertise, and digital solutions.",
	keywords: [
		"Ankit Seal",
	...
	twitter: {
		...
		description:
			"Portfolio showcasing web development projects, skills, and innovative digital solutions",
		images: ["/pfp.webp"],
	},
	robots: {
		index: true,
...
export default function RootLayout({
	...
	const creativeWorks = [
		{
			...
			description:
				"A chat application with modern UI and active chat moderation.",
			...
			keywords:
				"Chat Application, Real-time Chat, Chat Moderation, Web Development, Full Stack Development",
		...
		},
		{
			...
			description:
				"An interactive dashboard showing Spotify analytics and recently played tracks.",
			...
			keywords:
				"Spotify, Dashboard, Analytics, Web Development, Full Stack Development",
			datePublished: "2025-12-07",
			dateModified: "2025-12-07",
		},
	];
	...
	const personSchema = {
		...
		description:
			"Full-stack developer specializing in frontend, backend, system design, and cloud-ready applications.",
		knowsAbout: [
			"Web Development",
	...
	const webPageSchema = {
		...
		description:
			"Portfolio of Ankit Seal showcasing full-stack web development projects, blogs, chatbot integration, Spotify features, and contact information.",
		isPartOf: {
			"@id": "https://ankitseal.in#website",
		},
		inLanguage: "en",
		...
		<html lang="en" suppressHydrationWarning>
			<head>
				...
				<script
					type="application/ld+json"
					dangerouslySetInnerHTML={{
						__html: JSON.stringify(creativeWorks),
					}}
				/>
