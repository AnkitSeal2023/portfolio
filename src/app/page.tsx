...
export default function Page() {
	...
	// const y = useTransform(scrollYProgress, [0, 0.10], [-30, -135]);
	const scale = useTransform(scrollYProgress, [0, 0.18], [1, 0.3]);
	return (
		<div className='flex justify-center items-centerflex-col'>
			<Navbar />
			<div className="h-full max-w-3xl w-full px-5 py-18 ">
				...
				>
					<Image
						...
						width={150}
						height={150}
						className=" rounded-full flex justify-start border p-0.5 border-neutral-300 dark:border-neutral-700"
					/>
				...
				<div className='text-neutral-700 dark:text-neutral-400 font-normal py-6'>
					I do the whole stack—frontend polish, backend brains, and the glue that holds them together on a good day.
				</div>
				<div className="flex space-x-3">
					{/* <div className="cursor-pointer inset-shadow-indigo-500 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-xs font-medium transition-all
							disabled:pointer-events-none disabled:opacity-50
							[&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0
							outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]
							aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive
							border bg-background btn-inner-shadow hover:bg-accent hover:text-accent-foreground
							dark:bg-input/30 dark:border-input dark:hover:bg-input/50 h-9 px-4 py-2 has-[>svg]:px-3
						    [box-shadow:inset_0_0_2px_0_rgba(99,102,241,0.6)]"
